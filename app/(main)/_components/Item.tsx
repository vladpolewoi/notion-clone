  ...
  return (
    ...
    >
      {!!id && (
        <div
          role="button"
          className="h-full rounded-sm hover:bg-neutral-300 dark:bg-neutral-600 dark:hover:bg-neutral-600 mr-1"
      ...
      {isSearch && (
        <kbd className="ml-auto pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border bg-muted px-1.5 font-mono text-[10[10px] font-medium text-muted-foreground opacity-100">
